# CH99 handoff — notes and bibliography

- **Task ID:** CH99
- **Paths changed:** `book/manuscript/99_notes_bibliography.md`; this handoff.
...
- **Known gaps:** 18 screened records still require full-text inspection after the coordinator's R01-003 and R03-012 upgrades; final endnotes and page locators depend on layout.
