...
- Final art assets and per-asset provenance, dimensions, alt text, contrast, and exact-quantity checks are not complete book-wide; coordinator-reviewed vectors now exist for CH05, CH06, CH07, CH08, CH09, CH10, CH11, and CH12, while the remaining chapters are represented by production briefs.
